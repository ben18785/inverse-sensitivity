...
\begin{figure}[H]
	...
	\caption{\textbf{The non-linear mapping from parameter values (left panel) to outputs (right panel) means different sized regions of parameter space (orange and blue surfaces; left panel) correspond to distinct outputs (orange triangle and blue square; right panel).}}
