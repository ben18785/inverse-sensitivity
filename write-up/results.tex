...
\begin{equation}
\begin{aligned}
\alpha_i(x) &= \frac{x^2}{a_i^2 + x^2}\\
\beta_j(x) &= \frac{b_j^2}{b_j^2 + x^2},
\end{aligned}
\end{equation}
%
...
\begin{table}[htbp]
	...
	\begin{adjustwidth}{0in}{0in}%
		\begin{tabularx}{1.0\textwidth}{llllll}
			Model	& Target density & Parameter & Prior density & Prior $p_1$ & Prior $p_2$ \\
			\toprule
			Growth factor & 2-dimensional normal & $R_T$ & uniform & $2.5 \times 10^5$ &  $8 \times 10^5$\\
			&& $k_1$ & uniform & 0.25 & 3.0\\
			&& $k_{-1}$ & uniform & 2.0 & 20.0\\
			&& $k_{deg}$ & uniform & 0.005 & 0.03\\
			&& $k^*_{deg}$ & uniform & 0.1 & 0.5\\
			\toprule
			Growth factor & 2-dimensional normal & $R_T$ & normal & $5 \times 10^5$ &  $1 \times 10^5$\\
			&& $k_1$ & normal & 0.5 & 0.1\\
			&& $k_{-1}$ & normal & 3.0 & 1.0\\
			&& $k_{deg}$ & normal & 0.02 & 0.005\\
			&& $k^*_{deg}$ & normal & 0.3 & 0.1\\
			\toprule
			Michaelis-Menten & bimodal normal & $k_f$ & uniform & 0.2 &  15\\
			&& $k_r$ & uniform & 0.2 & 2.0\\
			&& $k_{cat}$ & uniform & 0.5 & 3.0\\
			\toprule
			Michaelis-Menten & 4-dimensional normal & $k_f$ & uniform & 0.2 &  15\\
			&& $k_r$ & uniform & 0.2 & 2.0\\
